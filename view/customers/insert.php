                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="x_content">
                                        <br />
                                        <form data-parsley-validate class="form-horizontal form-label-left" role="form" method="POST" action="index.php?controller=customers&method=insert_data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="resizable_textarea form-control" name="address" required="required"></textarea>
                                            </div>
                                        </div>
