                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <form data-parsley-validate class="form-horizontal form-label-left" role="form" method="POST" action="index.php?controller=sales&method=update_data">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="index.php?controller=sales&method=select" type="submit" class="btn btn-primary btn-lg">Cancel</a>
