                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="x_content">
                                        <br />
                                        <form data-parsley-validate class="form-horizontal form-label-left" role="form" method="POST" action="index.php?controller=categories&method=update_data">
                                        <?php
											$row  = mysql_fetch_array($data_categories);
										?>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Id Kategori Produk <span class="required">*</span>
                                            </label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" name="categories" id="first-name" value="<?php echo $row['name']; ?>" required="required" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12">
